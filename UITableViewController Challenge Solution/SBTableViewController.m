...
#warning Incomplete method implementation.
    ...
    if (section==0) return 2; else if (section==1) return 1; else return 3;
}


- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    static NSString *CellIdentifier = @"Cell"; // ADDED CODE
    ...
    {
        cell.textLabel.text = [NSString stringWithFormat:@"cell %i", indexPath.row]; // TAKE NOTES
    }
